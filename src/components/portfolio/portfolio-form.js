...
export default class PortfolioForm extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      logo: "",
      editMode: false,
      apiUrl: "https://shaunsenn.devcamp.space/portfolio/portfolio_items",
      apiAction: "post"
    };
  ...
  //Q: How can I tell in JS if an object is empty
  //or not? 
  //A: There is a "keys" property associated with the object.
  //See below usage of "keys" property
  componentDidUpdate() {
    if (Object.keys(this.props.portfolioToEdit).length > 0) {
      ...
      //Above, Line 55 is where I'm grabbing 
      //all of the deconstructed data from between lines 46-54

      this.props.clearPortfolioToEdit(); 
      //this goes into the parent component, portfolio-manager.js,
      //and it calls the clearPortfolioToEdit() function that's around line 28
      ...
      this.setState({
        ...
        url: url || "",
        editMode: true,
        apiUrl: `https://shaunsenn.devcamp.space/portfolio/portfolio_items/${id}`,
        apiAction: "patch",
